...
TEST(weapon_test, Test01ShootP90) {
    ...
    Position pos2(15, 10, soldier2->getWidth(), soldier2->getHeight());
...
TEST(weapon_test, Test02ShootP90ToTwoSoldiersInTheSameRow) {
    ...
    std::shared_ptr<Soldier> soldier = sfactory.create(P90SOLDIER);
    std::shared_ptr<Soldier> soldier2 = sfactory.create(P90SOLDIER);
    std::shared_ptr<Soldier> soldier3 = sfactory.create(P90SOLDIER);
    Position pos(10, 10, soldier->getWidth(), soldier->getHeight());
    Position pos2(15, 10, soldier2->getWidth(), soldier2->getHeight());
    Position pos3(20, 10, soldier3->getWidth(), soldier3->getHeight());
    ASSERT_NO_THROW(soldier->setPosition(std::move(pos)));
    ASSERT_NO_THROW(soldier2->setPosition(std::move(pos2)));
...
TEST(weapon_test, Test03ShootP90AndMiss) {
    ...
    std::shared_ptr<Soldier> soldier = sfactory.create(P90SOLDIER);
    std::shared_ptr<Soldier> soldier2 = sfactory.create(P90SOLDIER);
    Position pos(100, 10, soldier->getWidth(), soldier->getHeight());
    Position pos2(500, 100, soldier2->getWidth(), soldier2->getHeight());
    ASSERT_NO_THROW(soldier->setPosition(std::move(pos)));
    ASSERT_NO_THROW(soldier2->setPosition(std::move(pos2)));
    soldiers.emplace(2, std::move(soldier2));
    soldier->shoot(ON);
...
TEST(weapon_test, Test04ShootScout) {
    ...
    std::map<uint32_t, std::shared_ptr<Soldier>> soldiers;
    std::map<uint32_t, std::shared_ptr<Zombie>> zombies;
    std::shared_ptr<Soldier> soldier = sfactory.create(SCOUTSOLDIER);
    std::shared_ptr<Soldier> soldier2 = sfactory.create(P90SOLDIER);
    Position pos(10, 10, soldier->getWidth(), soldier->getHeight());
    Position pos2(15, 10, soldier2->getWidth(), soldier2->getHeight());
    ASSERT_NO_THROW(soldier->setPosition(std::move(pos)));
...
TEST(weapon_test, Test06ShootScoutToTwoSoldiersInTheSameRowLeft) {
    ...
    std::shared_ptr<Soldier> soldier2 = sfactory.create(P90SOLDIER);
    std::shared_ptr<Soldier> soldier3 = sfactory.create(P90SOLDIER);
    Position pos(20, 10, soldier->getWidth(), soldier->getHeight());
    Position pos2(15, 10, soldier2->getWidth(), soldier2->getHeight());
    Position pos3(10, 10, soldier3->getWidth(), soldier3->getHeight());
    ASSERT_NO_THROW(soldier->setPosition(std::move(pos)));
    ASSERT_NO_THROW(soldier2->setPosition(std::move(pos2)));
    ASSERT_NO_THROW(soldier3->setPosition(std::move(pos3)));
    soldiers.emplace(2, std::move(soldier2));
    ...
    soldier->shoot(ON);
    uint16_t time = 30;
    soldier->simulateMove(1, std::ref(soldiers), std::ref(zombies));
    soldier->simulateShoot(time, std::ref(soldiers), std::ref(zombies));
    std::shared_ptr<Soldier> &victim2 = soldiers.at(2);
    std::shared_ptr<Soldier> &victim3 = soldiers.at(3);
